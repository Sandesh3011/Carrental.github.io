...
<!-- <?php
 ...
 // servername => localhost
        ...
        //mysqli connect() Function:opens a new connection to the MySQL server.
            ...
            // Taking all 2 values from the form data(input)
            $name =  $_REQUEST['name'];//$_REQUEST is a PHP super global variable which is used to collect data after submitting an HTML form.
            $email = $_REQUEST['email'];
             
            // Performing insert query execution
            // here our table name is IT
            $sql = "INSERT INTO CSE  VALUES ('$name','$email')";
            //The INSERT INTO statement is used to insert new records in a table.
               /* INSERT INTO table_name (column1, column2, column3, ...)
                VALUES (value1, value2, value3, ...); 
    or  
            ...
            if(mysqli_query($conn, $sql)){
                ...
                echo nl2br("\n$name\n $email"); //nl2br() Function:Insert line breaks where newlines (\n) occur in the string
            } else{
                echo "ERROR: Hush! Sorry $sql. "
                    . mysqli_error($conn);
            }
